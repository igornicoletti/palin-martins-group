...
export const About = () => {
  ...
  return (
    <section className="bg-background min-h-screen flex flex-col justify-center relative">
      ...
      <button onClick={scrollToNextSection} className="absolute cursor-pointer bottom-10 left-1/2 transform -translate-x-1/2 text-foreground-typography/20 hover:text-primary transition-colors animate-bounce">
